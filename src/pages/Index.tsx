      ...
      >
        <div className="relative z-10 text-center max-w-lg mx-auto lg:max-w-4xl 2xl:max-w-7xl">
          <div className='w-full flex items-center justify-center'>
            <h1 className="w-9/12 2xl:w-8/12 text-4xl font-medium mb-6 leading-tight lg:text-5xl 2xl:text-7xl lg:mb-8" style={{ textShadow: '0px 2px 10px rgb(0,0,0,1)' }}>
        ...
        <div className="relative z-10 lg:max-w-6xl 2xl:max-w-7xl mx-auto">
          ...
          <div className="space-y-8 lg:space-y-12">
            <div className="text-center">
              <p className="text-white text-lg lg:text-xl font-regular mb-6 opacity-25">
                Mais de <span className="font-bold">20 mil kits</span> de cadastramento biométrico integrados ao TSE
              </p>
              <p className="text-white text-lg lg:text-xl font-regular mb-6 opacity-50">
                Presença em todos os estados brasileiros
              </p>
              <p className="text-white text-lg lg:text-xl font-regular mb-6">
        ...
        <div className="max-w-lg mx-auto lg:max-w-6xl">
          <div className="bg-[#1A1A1A] rounded-lg p-10 lg:p-12 lg:grid lg:grid-cols-2 lg:gap-12 lg:items-center h-[350px] sm:h-[450px]"
            style={{
              ...
              backgroundSize: 'cover' // ou 'cover' se quiser preencher o espaço todo
            }}
          >
